...
Original file is located at
    https://colab.research.google.com/drive/1pHhmuPG5k0NWmpV2XNhHQeIotJffoVdk
...
def trainer(train_loader, valid_loader, model, config, device):
    ...
    optimizer = torch.optim.AdamW(model.parameters(), lr=config['learning_rate'], betas=(0.9,0.999),eps=1e-08, weight_decay=5e-5, amsgrad = True)
    scheduler =  torch.optim.lr_scheduler.CosineAnnealingLR(optimizer = optimizer,T_max =  config['n_epochs']) 
